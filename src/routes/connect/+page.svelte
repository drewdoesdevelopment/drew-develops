<script lang="ts">
	...
	function checkSpamInputValue(spamInputValue) {
		if (
			spamInputValue.target.value === '15' ||
			spamInputValue.target.value === 'fifteen' ||
			spamInputValue.target.value === 'fiften'
		) {
...
<svelte:head>
    ...
    <meta name="description" content="Get in touch with Drew P. (Drew Develops) — software engineer available for freelance, consulting, and accessibility work." />
				...
				<ul>
					<li>
						<a
							...
							target="_blank"
							rel="noreferrer"
							aria-label="Drew Develops GitHub profile"
						>
					...
					<li>
						<a
							href="https://instagram.com/drew_develops"
							target="_blank"
							rel="noreferrer"
							aria-label="Drew Develops Instagram profile"
						>
							<svg
								width="800px"
								height="800px"
						...
						<div class="flex-1">
							...
							<label>
								...
								<input
									...
									required
									type="email"
									placeholder="tony@starkindustries.net"
								/>
							</label>
