<div class="expertise-items">
    ...
    <div class="expertise-item">
        ...
        <p>
            I offer development for scripts and setup for third-party integration/automation services (SharePoint,
            etc) that can save you time and provide powerful insights.       </p>
    </div>
</div>
<style lang="scss">
